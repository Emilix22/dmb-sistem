                ...
                <AreaChart width={730} height={250} data={data}
                    ...
                    <defs>
                        <linearGradient id="Total" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor="#002a7c" stopOpacity={0.8} />
                            <stop offset="95%" stopColor="#002a7c" stopOpacity={0} />
                        </linearGradient>
                    </defs>
                    <XAxis dataKey="name" stroke="gray" />
                    <CartesianGrid strokeDasharray="3 3" className="chartGrid" />
                    <Tooltip />
                    <Area type="monotone" dataKey="Total" stroke="#002a7c" fillOpacity={1} fill="url(#Total)" />
                </AreaChart>
            </ResponsiveContainer>
        </div>
    )
